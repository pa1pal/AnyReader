...
/**
 * Created by Rajan Maurya on 13/09/16.
 */
public class ARBaseFragment extends Fragment {

    private InputMethodManager mInputMethod;
    private ARProgressBarHandler mConvokeProgressBarHandler;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mConvokeProgressBarHandler = new ARProgressBarHandler(getActivity());
    }
